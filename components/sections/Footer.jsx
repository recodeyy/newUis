        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-[18px] font-bold text-white tracking-tight ml-1">Recody</span>
            </div>
          </div>
          ...
          <div>
             <div className="text-[12px] font-medium text-[#93c5fd] underline underline-offset-4 decoration-white/20 mb-6">Credits</div>
